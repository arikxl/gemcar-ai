...
CREATE TABLE "DealershipInfo" (
    "id" TEXT NOT NULL,
    "name" TEXT NOT NULL DEFAULT 'Inertia Cars',
    "address" TEXT NOT NULL DEFAULT 'Hashila 15, Beer Sheva, Israel',
    "phone" TEXT NOT NULL DEFAULT '+972 (50) 686-0169',
    "email" TEXT NOT NULL DEFAULT 'cars@inertia.com',
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
